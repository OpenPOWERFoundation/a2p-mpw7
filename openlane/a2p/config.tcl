...
set ::env(VERILOG_FILES) "\
	...
	$script_dir/../../verilog/rtl/a2p/a2p.v \
	$script_dir/../../verilog/rtl/a2p/gpr.v \
	$script_dir/../../verilog/rtl/a2p/dir.v \
	$script_dir/../../verilog/rtl/a2p/cache.v \
   "
# ---------------------------------------------------------------------------------------------
# Macros
...
set ::env(VERILOG_FILES_BLACKBOX) "\
	...
	$script_dir/../../verilog/rtl/DFFRAM/wrapper/RAM32.v \
	$script_dir/../../verilog/rtl/microwatt/wrapper/RAM32_1RW1R.v \
   "

# generated lef, gds, lib
# RAM32_1RW1R uwatt
set ::env(EXTRA_LEFS) "[glob $::env(DESIGN_DIR)/../../macros/DFFRAM/lef/*.lef] [glob $::env(DESIGN_DIR)/../../macros/microwatt/lef/*.lef]"
set ::env(EXTRA_GDS_FILES) "[glob $::env(DESIGN_DIR)/../../macros/DFFRAM/gds/*] [glob $::env(DESIGN_DIR)/../../macros/microwatt/gds/*]"
#set ::env(EXTRA_LEFS) "[glob $::env(DESIGN_DIR)/../../macros/DFFRAM/lef/*.lef]"
#set ::env(EXTRA_GDS_FILES) "[glob $::env(DESIGN_DIR)/../../macros/DFFRAM/gds/*]"
...
set ::env(FP_PDN_MACRO_HOOKS) "\
   ...
   IBusCachedPlugin_cache.ic.genblk1.genblk1.ra vccd1 vssd1 \
   dataCache_1_.dc.genblk1.genblk1.ra       vccd1 vssd1 \
   "
#	RegFilePlugin_regFile.gpr.rf_0 	vccd1 vssd1 \
#	RegFilePlugin_regFile.gpr.rf_1 	vccd1 vssd1 \
