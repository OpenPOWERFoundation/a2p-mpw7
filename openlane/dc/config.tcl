...
# scala DataCache with tag,data inside
set ::env(DESIGN_NAME) DataCache
...
set ::env(VERILOG_FILES_BLACKBOX) "\
	$script_dir/../../verilog/rtl/DFFRAM/wrapper/RAM32_1RW1R.v \
   "
# generated lef, gds, lib
set ::env(EXTRA_LEFS) $::env(DESIGN_DIR)/../../macros/DFFRAM/lef/RAM32_1RW1R.lef
set ::env(EXTRA_GDS_FILES) $::env(DESIGN_DIR)/../../macros/DFFRAM/gds/RAM32_1RW1R.gds

# instantiated macro names - fails at this level for some reason
#set ::env(FP_PDN_MACRO_HOOKS) "\
#   dc.genblk1.genblk1.ra vccd1 vssd1 \
#  "
